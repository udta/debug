            ...
            createTransaction(self._dbInfo, READ_ONLY, function (err, transaction) {
                ...
                try {
                    ...
                    if ('getAll' in store) {
                        ...
                        //For Indexed DB 2.0 only, details on https://caniuse.com/#search=indexeddb
                        req = store.getAll();
                        ...
                        req.onsuccess = function (event) {
                            ...
                            if (cursor) {
                                if (_isEncodedBlob(cursor.value)) {
                                    cursor.value = _decodeBlob(cursor.value);
                                }
...
function setItems(keys, values, callback) {
    var self = this;
    ...
    var promise = new Promise$1(function (resolve, reject) {
        ...
        self.ready().then(function () {
            dbInfo = self._dbInfo;
            if (toString.call(values) === '[object Blob]') {
                return _checkBlobSupport(dbInfo.db).then(function (blobSupport) {
                    if (blobSupport) {
                        return values;
                    }
                    return _encodeBlob(values);
                });
            }
            return values;
...
var DefaultDriverOrder = [DefaultDrivers.INDEXEDDB._driver //,
            ...
            return function () {
                ...
                function driverPromiseLoop() {
                    while (currentDriverIndex < supportedDrivers.length) {
                        ...
                        return self.getDriver(driverName).then(extendSelfWithDriver)["catch"](function (e) {
                            console.log('OoOoOoOoOoOoOoOOOOOoO ' + e);driverPromiseLoop();
                        });
                    }
